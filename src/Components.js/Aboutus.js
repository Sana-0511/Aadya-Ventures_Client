...
const AboutUs = () => {
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="mb-4">At XYZ Real Estate, we are dedicated to helping you find your dream home. Our experienced team of real estate professionals is here to assist you every step of the way.</p>
      <h2 className="text-2xl font-bold mb-2">Our Services</h2>
      <p>Whether you're buying, selling, or renting a property, we offer a range of services to meet your needs:</p>
      ...
      <p>We have a dedicated team of real estate agents who are committed to providing exceptional service:</p>
      <ul className="list-disc pl-6 mb-4">
        <li>John Doe - CEO</li>
        <li>Jane Smith - Sales Manager</li>
        <li>Michael Johnson - Property Consultant</li>
        <li>Sarah Davis - Rental Specialist</li>
      </ul>
